...
const Wallpaper = () => {
    ...
    return (
        <div >
                            ...
                            {wallpaper.is_locked ? (
                                ...
                                <>
                                    ...
                                    <button
                                        ...
                                        onClick={(e) => {
                                            e.stopPropagation();
                                            window.location.href = route('wallpaper.download', wallpaper.id);
                                        }}
                                    >
            ...
            {selectedWallpaper && (
                <div className={styles.modal_overlay} onClick={closePreview}>
                    <div className={styles.modal_content} onClick={(e) => e.stopPropagation()}>
                        <button className={styles.close_button} onClick={closePreview}>
                        ...
                        <img
                            ...
                            alt={selectedWallpaper.alt || selectedWallpaper.title}
                            className={styles.modal_image}
                        />
                        <div className={styles.modal_info}>
                            <h3 className={styles.modal_info_title}>{selectedWallpaper.title}</h3>
                            <button
                                className={styles.modal_download}
                                onClick={() => {
                                    const link = document.createElement('a');
                                    link.href = selectedWallpaper.src;
                                    link.download = `${selectedWallpaper.title.replace(/\s+/g, '-').toLowerCase()}.jpg`;
