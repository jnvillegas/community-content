    ...
    return (
        <div>
            ...
            <div className={styles.main}>
                <h2 className={styles.title_main}>Entre Em Contato</h2>

                <div className={styles.link_content}>
                    <div className={styles.contact_group}>
                        <span className={styles.label}>Facebook</span>
                        <a href="https://www.facebook.com/vivendoemviagem" target="_blank" className={styles.contact_link}>
                            <svg className={styles.icon} viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
                                <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
                            </svg>
                            <span>@Vivendoemviagem</span>
                        </a>
                    </div>

                    <div className={styles.contact_group}>
                        <span className={styles.label}>Instagram</span>
                        <a href="https://www.instagram.com/vivendoemviagem" target="_blank" className={styles.contact_link}>
                    ...
                    <div className={styles.contact_group}>
                        ...
                        <a href="https://www.youtube.com/@vivendoemviagem" target="_blank" className={styles.contact_link}>
                ...
                <div className={styles.photo_container}>
                    <img
                        ...
                        alt="Deividi and Paula on the road"
