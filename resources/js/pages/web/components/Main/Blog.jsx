    ...
    const BLOG_ITEMS = [
        {
            ...
            title: "Onde a floresta tropical encontra o oceano",
            description:
                "O som do Atlântico batendo contra o recife. O aroma de óleo de coco e areia quente. Um santuário tanto para tartarugas marinhas quanto para almas cansadas.",
        },
        {
            id: "iguape",
            variant: "tall",
            image:
                "https://lh3.googleusercontent.com/aida-public/AB6AXuBVcgvNc9oCmJVGlZOOUnVES_oUlxdQ5g0hs_VtB2UpFY-ANM6Z_bWMsSizQFiLmjxtnvWjmkcIP93fey1xNVxN9q5XKtGs_f6flwYvRiNfohJfa4-fTD_EPtrsLItvBj_cKuMTVU9xiPJAigzM_DXKcWnd3fuJMrxHeU9FeMWTrP4YeYXdM9ebO758zJdcGzwey_-75DNRX5OAZzIQMBPQHDlxpCwqfSBBGikfNerV7q2Tu2SZpvoyuFEZS-6WXLgtoE92wbjAyxQ",
            location: "Iguape, SP",
            title: "Ecos da História",
            description: "Ruas de paralelepípedos que sussurram histórias do passado.",
        },
        {
            id: "serra",
            variant: "small",
            image:
                "https://lh3.googleusercontent.com/aida-public/AB6AXuDpV0qm6RTAQEL-9KT95g3ub1RDjmo9LpHVHTI0p2xGum2X6uq8zornYrrQpAUMqVEtXj8qAO337zIx9SgLyYBFDij7gnXwofGqIQ_i7kAHTLZ2I4M3ahCidSGgGxzS3CWbErvaqzLAqLj_OIU8l4BOISBzlGDPENyJddta0hb2mGUZDelxX91A6oNQlzOTw6Y2XkHp3PJRZfjRa0WyDaG9mA_1goZxIXMzTMi16P2Z5vLh-lFMCZgRT8J80fBpdgRPGFJZJqhFxaQ",
            location: "Serra do Rio do Rastro, SC",
            title: "A Serra do Rio do Rastro",
            description: "Desafiando a gravidade na beira do precipício.",
        },
        {
            id: "flavor",
            variant: "small",
            image:
                "https://lh3.googleusercontent.com/aida-public/AB6AXuDskd4Y13KpEA4z1oPP6lzVQb_7DomiZJisNMHfIKiF5OBgKsKKqA_-Wh-i0faA3mW95BrXQkXoxsl0cgFZltb1FZBxC9EkOhZ79f5QCJhSBKvyJgwxTT-vtbsA4R65mfkNr6t2kk0nFmhnakXoAP4txN-ntog69GMKmUMVheJ5fMGggq7rM6Uen_kiqy6CaOt8I_d9n98yAQ29bIn1SdWDvvW7UBX-KJpREX9vYIZN4d96FI6bYG_b9dvAZWyiyId1aja2NKIW81I",
            location: "Brazil",
            title: "Sabor da Selva",
            description: "Cozinhar com ingredientes locais.",
        },
    ];
            ...
            <div className={styles.container}>
                ...
                <div className={styles.grid}>
                    {BLOG_ITEMS.map((item) => {
                        const cardClass = [
                            styles.card,
                            item.variant === "featured" && styles.featured,
                            item.variant === "tall" && styles.tall,
                        ]
                            .filter(Boolean)
                            .join(" ");

                        const isLarge = item.variant === "featured";
