...
const eventsData = [
    ...
    },
    {
        ...
        author: {
            ...
            avatars: [
                'https://lh3.googleusercontent.com/aida-public/AB6AXuDRcQDYhZJ1yAl2b5KqP0mBWLvt_C8JVDvsMuKMQ3OX96gMOypSe_CHp0zUffNoinbyrUKsGJLiGgsTHreXzaZar11Wvv-MteCXA2y78RPFHMWE1T3Ujf-wxqcxhvMXLZmrsHG6crB7PcwFL6LGjrlqDCl6r7ncOMMU_OtMBVZIrwGMgjcagv0ruAYjVJzsjwPQMByA7DQTlfnD2ieJdfODppWZFCaIf9JPOXnKek7mj3MJhc-LzejKgPiYlyecdcg_r7uSIccB2AU',
                'https://lh3.googleusercontent.com/aida-public/AB6AXuAdS-0DyqekUxCW3PWV0kZiXdslNYbdx_NCTJPJJFThzyzbLApOTgnEdbmbTI-nUA56mE_FAW_E_UzGCX4CSjnHjzXiunQ3uXs_Cj_iFUP3qzS_PjA1fq_viv0523p9Ptj8eNizsKMCn2Ddm6nllzroxmkuCwvMgr-8uMWSIXLsE0bOMYwhWZq7eg-namIJo02mLVvZPRKXTZske43X9KFacleyHM3X7LW44LR4malf4TQeV7LUvKpdZX1YHe1A-V6B18y0kH08_iQ',
            ],
        },
        likesCount: 28000,
        shares: '1.2k',
                            ...
                            <div key={event.id} className={styles.masonry_item}>
                                ...
                                <div className={styles.glass_overlay}>
                                    ...
                                    <div className={styles.author_row}>
                                        {event.author.avatars ? (
                                            <div className="flex -space-x-3">
                                                {event.author.avatars.map((av, idx) => (
                                                    <img
                                                        key={idx}
                                                        src={av}
                                                        alt="Team member"
