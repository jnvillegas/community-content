...
const Events = () => {
    ...
    const { events, event, toggleLike } = usePage().props;
    ...
    return (
        <div className={styles.events_container}>
            ...
            {selectedEvent && (
                <EventsModal event={selectedEvent} onClose={() => setSelectedEvent(null)} formatDate={formatDate} />
            )}
                                ...
                                <div className={styles.glass_overlay}>
                                    <div className={styles.actions_column}>
                                        <button className={styles.action_button} onClick={() => toggleLike(event.id)}>
                                            ...
                                            <span className={styles.action_count}>{event.likes_count}</span>
                                        </button>

                                        <button className={styles.action_button} onClick={() => setSelectedEvent(event)}>
                                            ...
                                            {event.comments_count > 0 && <span className={styles.action_count}>{event.comments_count}</span>}
                                        </button>
                                    ...
                                    <div className={styles.event_meta}>
                                        ...
                                        <div>
                                            {event.location_url && (
                                                <a className={styles.location_tag} href={event.location_url} target='_blank'>
